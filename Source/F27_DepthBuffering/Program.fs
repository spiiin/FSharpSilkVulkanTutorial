...
type HelloTriangleApplication() =
    ...
    let vertices = [| 
        Vertex(Vector3D(-0.5f, -0.5f, 0.0f), Vector3D(1.0f, 0.0f, 0.0f), Vector2D(1.0f, 0.0f))
        Vertex(Vector3D(0.5f, -0.5f, 0.0f), Vector3D(0.0f, 1.0f, 0.0f), Vector2D(0.0f, 0.0f))
        Vertex(Vector3D(0.5f, 0.5f, 0.0f), Vector3D(0.0f, 0.0f, 1.0f), Vector2D(0.0f, 1.0f))
        Vertex(Vector3D(-0.5f, 0.5f, 0.0f), Vector3D(1.0f, 1.0f, 1.0f), Vector2D(1.0f, 1.0f))

        Vertex(Vector3D(-0.5f, -0.5f, -0.5f), Vector3D(1.0f, 0.0f, 0.0f), Vector2D(1.0f, 0.0f))
        Vertex(Vector3D(0.5f, -0.5f, -0.5f), Vector3D(0.0f, 1.0f, 0.0f), Vector2D(0.0f, 0.0f))
        Vertex(Vector3D(0.5f, 0.5f, -0.5f), Vector3D(0.0f, 0.0f, 1.0f), Vector2D(0.0f, 1.0f))
        Vertex(Vector3D(-0.5f, 0.5f, -0.5f), Vector3D(1.0f, 1.0f, 1.0f), Vector2D(1.0f, 1.0f))
    |]
    let indices = [|
        0us; 1us; 2us; 2us; 3us; 0us;
        4us; 5us; 6us; 6us; 7us; 4us;
    |]
