...
type Vertex =
    ...
    new (pos: Vector2D<float32>, color: Vector3D<float32>, texCoord: Vector2D<float32>) = { pos = pos; color = color; texCoord = texCoord }
...
type HelloTriangleApplication() =
    ...
    let vertices = [| 
        Vertex(Vector2D(-0.5f, -0.5f), Vector3D(1.0f, 0.0f, 0.0f), Vector2D(1.0f, 0.0f))
        Vertex(Vector2D(0.5f, -0.5f), Vector3D(0.0f, 1.0f, 0.0f), Vector2D(0.0f, 0.0f))
        Vertex(Vector2D(0.5f, 0.5f), Vector3D(0.0f, 0.0f, 1.0f), Vector2D(0.0f, 1.0f))
        Vertex(Vector2D(-0.5f, 0.5f), Vector3D(1.0f, 1.0f, 1.0f), Vector2D(1.0f, 1.0f))
    |]
